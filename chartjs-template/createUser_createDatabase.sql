...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2023 at 12:56 PM
...
--
-- Database: `student_classicmodels`
--
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `dashboardsatisfactionprocedure` ()   BEGIN
    SELECT
        `User`,
        `SatisfactionRating`,
        `Feedback`
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `dashdevtimeprocedure` ()   BEGIN
    SELECT Project,
           `DataProcessingTime`,
           `DashboardDevelopmentDays`
    FROM dashdevtime;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `dataanalysistechniquesprocedure` ()   BEGIN
    SELECT
        `Year`,
        `Techniques`,
        `Methodologies`
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `decisionmakingprocedure` ()   BEGIN
    SELECT
        `Year`,
        `DecisionMaking`,
        `InnovativePractices`
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `hostingexpensesprocedure` ()   BEGIN
    SELECT
        `Month`,
        `HostingExpenses`
    FROM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `intergrationaccuracyprocedure` ()   BEGIN
SELECT Project, IntegrationAccuracy, DataDiscrepancies, Delays
FROM integrationaccuracy;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `Top5SellingProductsofTheYear` (IN `currentYear` INT)   BEGIN
SELECT 
    ROW_NUMBER() OVER (
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `userengagementprocedure` ()   BEGIN
    SELECT
        `Month`,
        `UserEngagement`,
        `UserUsage`,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `webappsizeprocedure` ()   BEGIN
    SELECT
        `Version`,
        `CodebaseSize`
    FROM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `YOYSalesRevenuePerMonth` (IN `currentYear` INT)   BEGIN
SELECT 
...
--
-- Table structure for table `dashboardsatisfaction`
--

CREATE TABLE `dashboardsatisfaction` (
  `User` int(11) NOT NULL,
  `SatisfactionRating` decimal(3,1) NOT NULL,
  `Feedback` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `dashboardsatisfaction`
--

INSERT INTO `dashboardsatisfaction` (`User`, `SatisfactionRating`, `Feedback`) VALUES
(1, 4.5, 'Great dashboard, very user-friendly'),
(2, 3.8, 'Some features can be improved'),
(3, 4.2, 'Excellent support from the team'),
(4, 4.0, 'I find the dashboard very informative'),
(5, 4.5, 'The visuals are appealing and easy to interpret'),
(6, 3.5, 'The dashboard layout could be better organized'),
(7, 4.1, 'Good variety of data displayed'),
(8, 3.9, 'Dashboard helps in making informed decisions'),
(9, 4.3, 'User-friendly interface, but needs more customization options'),
(10, 4.6, 'Data accuracy is reliable and up-to-date'),
(11, 3.7, 'Dashboard loading speed needs improvement'),
(12, 4.4, 'In-depth analysis features are very useful'),
(13, 3.5, 'Dashboard lacks some essential metrics'),
(14, 4.2, 'Easy-to-use navigation and filters'),
(15, 3.8, 'Could benefit from more visualization options'),
(16, 4.7, 'The dashboard has improved our decision-making process'),
(17, 3.9, 'User onboarding process could be smoother'),
(18, 4.3, 'Quick access to important information'),
(19, 4.1, 'Data export feature is very helpful'),
(20, 3.6, 'Occasional lag in dashboard responsiveness');

-- --------------------------------------------------------

--
-- Table structure for table `dashdevtime`
--

CREATE TABLE `dashdevtime` (
  `Project` int(11) NOT NULL,
  `DataProcessingTime` int(11) NOT NULL,
  `DashboardDevelopmentDays` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `dashdevtime`
--

INSERT INTO `dashdevtime` (`Project`, `DataProcessingTime`, `DashboardDevelopmentDays`) VALUES
(1, 30, 25),
(2, 25, 20),
(3, 20, 18),
(4, 28, 22),
...
--
-- Table structure for table `dataanalysistechniques`
--

CREATE TABLE `dataanalysistechniques` (
  `Year` int(11) NOT NULL,
  `Techniques` int(11) NOT NULL,
  `Methodologies` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `dataanalysistechniques`
--

INSERT INTO `dataanalysistechniques` (`Year`, `Techniques`, `Methodologies`) VALUES
(2018, 10, 5),
(2019, 15, 8),
(2020, 20, 12),
(2021, 25, 15),
...
--
-- Table structure for table `decisionmaking`
--

CREATE TABLE `decisionmaking` (
  `Year` int(11) NOT NULL,
  `DecisionMaking` decimal(10,0) NOT NULL,
  `InnovativePractices` decimal(10,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `decisionmaking`
--

INSERT INTO `decisionmaking` (`Year`, `DecisionMaking`, `InnovativePractices`) VALUES
(2022, 90, 60),
(2023, 85, 55),
(2024, 75, 45),
(2025, 70, 40),
...
--
-- Table structure for table `hostingexpenses`
--

CREATE TABLE `hostingexpenses` (
  `Month` int(11) NOT NULL,
  `HostingExpenses` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `hostingexpenses`
--

INSERT INTO `hostingexpenses` (`Month`, `HostingExpenses`) VALUES
(1, 1000),
(2, 900),
(3, 800),
(4, 850),
...
--
-- Table structure for table `integrationaccuracy`
--

CREATE TABLE `integrationaccuracy` (
  `Project` int(11) NOT NULL,
  `IntegrationAccuracy` int(11) NOT NULL,
  `DataDiscrepancies` int(11) NOT NULL,
  `Delays` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `integrationaccuracy`
--

INSERT INTO `integrationaccuracy` (`Project`, `IntegrationAccuracy`, `DataDiscrepancies`, `Delays`) VALUES
(1, 90, 5, 2),
(2, 85, 6, 3),
(3, 88, 4, 1),
(4, 92, 3, 1),
...
CREATE TABLE `userengagement` (
  `Month` int(11) NOT NULL,
  `UserEngagement` int(11) NOT NULL,
  `UserUsage` int(11) NOT NULL,
  `PositiveFeedback` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `userengagement`
--

INSERT INTO `userengagement` (`Month`, `UserEngagement`, `UserUsage`, `PositiveFeedback`) VALUES
(1, 70, 50, 20),
(2, 80, 60, 25),
(3, 85, 70, 30),
(4, 75, 55, 22),
...
--
-- Table structure for table `webappsize`
--

CREATE TABLE `webappsize` (
  `Version` int(11) NOT NULL,
  `CodebaseSize` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `webappsize`
--

INSERT INTO `webappsize` (`Version`, `CodebaseSize`) VALUES
(1, 100),
(2, 90),
(3, 80),
(4, 70),
...
--
-- Indexes for table `dashboardsatisfaction`
--
ALTER TABLE `dashboardsatisfaction`
  ADD PRIMARY KEY (`User`);

--
-- Indexes for table `dashdevtime`
--
ALTER TABLE `dashdevtime`
  ADD PRIMARY KEY (`Project`);

--
-- Indexes for table `dataanalysistechniques`
--
ALTER TABLE `dataanalysistechniques`
  ADD PRIMARY KEY (`Year`);

--
-- Indexes for table `decisionmaking`
--
...
--
-- Indexes for table `hostingexpenses`
--
ALTER TABLE `hostingexpenses`
  ADD PRIMARY KEY (`Month`);

--
-- Indexes for table `integrationaccuracy`
--
ALTER TABLE `integrationaccuracy`
  ADD PRIMARY KEY (`Project`);
...
--
-- Indexes for table `webappsize`
--
ALTER TABLE `webappsize`
...
--
-- AUTO_INCREMENT for table `dashboardsatisfaction`
--
ALTER TABLE `dashboardsatisfaction`
  MODIFY `User` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `dashdevtime`
--
ALTER TABLE `dashdevtime`
  MODIFY `Project` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `dataanalysistechniques`
--
ALTER TABLE `dataanalysistechniques`
  MODIFY `Year` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2038;

--
-- AUTO_INCREMENT for table `decisionmaking`
--
ALTER TABLE `decisionmaking`
  MODIFY `Year` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2042;

--
-- AUTO_INCREMENT for table `hostingexpenses`
--
ALTER TABLE `hostingexpenses`
  MODIFY `Month` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `integrationaccuracy`
--
ALTER TABLE `integrationaccuracy`
  MODIFY `Project` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `webappsize`
--
ALTER TABLE `webappsize`
  MODIFY `Version` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
